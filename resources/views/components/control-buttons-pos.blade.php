...
<div class="help-left">
    ...
    <div class="buttons-right">
        <button class="hold-button">
            <span>Hold</span><svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button class="save-button">
            <span>Save</span><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button class="cancel-button">
            <span>Cancel</span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
